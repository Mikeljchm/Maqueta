...
(function(){
  ...
  ps.textContent = [
    ...
    '.prof-avatar-row{padding:0 1rem;margin-top:-16px;margin-bottom:0;position:relative;z-index:2;display:flex;align-items:center;gap:0;}'
