...
(function(){
  ...
  ps.textContent = [
    ...
    '.prof-avatar-row{padding:0 1rem;margin-top:-36px;margin-bottom:0;position:relative;z-index:2;display:flex;align-items:center;gap:0;}'
    + '.prof-ig-stats{width:100%;display:flex;padding:1.25rem 0 0.25rem;}'
