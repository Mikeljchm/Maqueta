...
(function(){
  ...
  window.openMiniProfile = function openMiniProfile(uid, name) {
    ...
    page.innerHTML =
      ...
      + '<div style="padding:0 1rem;margin-top:-20px;display:flex;align-items:center;gap:1rem;flex-shrink:0;">'        + '<div id="user-prof-av" style="width:72px;height:72px;border-radius:50%;border:3px solid var(--bg);background:var(--surface-2);display:flex;align-items:center;justify-content:center;font-family:var(--font-d);font-size:1.6rem;overflow:hidden;flex-shrink:0;position:relative;z-index:3;"></div>'      + '</div>'
