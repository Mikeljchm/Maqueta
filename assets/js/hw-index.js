...
(function(){
  ...
  cs.textContent = [
    ...
    '.pc-act-btn{background:none;border:none;color:#aaa;cursor:pointer;display:flex;align-items:center;gap:0.3rem;padding:0.4rem 0.55rem;border-radius:8px;font-family:var(--font-b);font-size:0.75rem;transition:color 0.15s;}',
